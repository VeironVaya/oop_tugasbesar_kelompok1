      ...
      <form onSubmit={handleSave}>
        ...
        <div className="mt-10 pt-6 border-t">
          <div className="flex justify-between items-center mb-4">
            ...
            <Link to={`/edit/${productId}/addstock`} className="text-blue-600 hover:text-blue-800 hover:underline font-semibold">
              Add Stock
            </Link>
          </div>
        ...
        <div className="mt-8 flex justify-end">
          <button type="submit" className="bg-gray-800 text-white font-bold py-2 px-6 rounded-lg hover:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800">
            Save Changes
          </button>
        </div>
      </form>
